...
***Psychic Lash (Costs 3 Actions).*** The emissary targets a creature it can see within 30 feet of it and psychically lashes at that creature's mind. The target must succeed on a DC 21 Wisdom saving throw or take 36 (`8d8`) psychic damage and be [stunned](rules/conditions.md#stunned) until the start of its next turn.
```
^statblock