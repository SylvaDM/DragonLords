...
---
# Construct Spirit (9th-level Spell)
*Source: Tasha's Cauldron of Everything p. 111*  

```ad-statblock
title: Construct Spirit (9th-level Spell)
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/TCE/Construct%20Spirit.webp#token)
*Medium construct, Unaligned*

- **Armor Class** 22  (natural armor)
- **Hit Points** 115  (40 + 15 for each spell level above 4th)
- **Speed** 30 ft.
...
***Slam.*** *Melee Weapon Attack:* the summoner's spell attack modifier to hit, reach 5 ft., one target. *Hit:* `1d8 + 4 + summonSpellLevel` bludgeoning damage.
