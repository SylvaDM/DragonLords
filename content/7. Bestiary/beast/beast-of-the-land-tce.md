...
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/TCE/Beast%20of%20the%20Land.webp#token)
...
***Maul.*** *Melee Weapon Attack:* the summoner's spell attack modifier to hit, reach 5 ft., one target. *Hit:* `1d8 + 2 + PB` slashing damage.
```
^statblock