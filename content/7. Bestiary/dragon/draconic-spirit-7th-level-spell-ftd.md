...
---
# Draconic Spirit (7th-level Spell)
*Source: Fizban's Treasury of Dragons p. 21*  

```ad-statblock
title: Draconic Spirit (7th-level Spell)
...
- **Hit Points** 70  (50 + 10 for each spell level above 5th (the dragon has a number of Hit Dice [d10s] equal to the level of the spell))
