...
```ad-statblock
title: Draconic Spirit (6th-level Spell)
...
- **Hit Points** 60  (50 + 10 for each spell level above 5th (the dragon has a number of Hit Dice [d10s] equal to the level of the spell))
