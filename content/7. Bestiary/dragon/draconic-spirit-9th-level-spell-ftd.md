...
- monster/size/large
- monster/type/dragon
aliases: ["Draconic Spirit (9th-level Spell)"]
---
# Draconic Spirit (9th-level Spell)
*Source: Fizban's Treasury of Dragons p. 21*  

```ad-statblock
title: Draconic Spirit (9th-level Spell)
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/FTD/Draconic%20Spirit.webp#token)
*Large dragon, Neutral*

- **Armor Class** 23  (natural armor)
- **Hit Points** 90  (50 + 10 for each spell level above 5th (the dragon has a number of Hit Dice [d10s] equal to the level of the spell))
