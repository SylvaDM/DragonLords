...
At the end of each long rest, an infected creature can make a DC 13 Constitution saving throw. On a successful save, the DC for this save and for the save to avoid an attack of mad laughter drops by `1d6`. When the saving throw DC drops to 0, the creature recovers from the disease. A creature that fails three of these saving throws gains a randomly determined form of [Madness](rules/variant-rules/madness.md).
...
The Gnaws is spread when a creature is bitten by a rat, giant rat, [swarm of rats](compendium/bestiary/beast/swarm-of-rats.md), or wererat that carries the disease, or by coming into physical contact with an infected creature.
...
It takes `1d2` days for the Gnawing Plague's symptoms to manifest in an infected creature. The infected creature then gains 1 level of [exhaustion](rules/conditions.md#exhaustion), regains only half the normal number of hit points from spending Hit Dice, and regains no hit points from finishing a long rest.
